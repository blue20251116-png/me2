...
async function generateLifestyleImage(accountId, { productName, productImageUrl, scene }, publicBaseUrl) {
  ...
  const prompt =
    ...
    '- 상품 자체의 색상·형태·재질·비율은 원본 레퍼런스와 최대한 동일하게 유지\n' +
    '- 스튜디오 무배경 촬영이나 과도한 상업광고 느낌은 피하고, 생활 속에 자연스럽게 놓인 느낌으로\n' +
    '- 다만 "우연히 찍힌 스마트폰 스냅샷"처럼 일부러 흔들리거나 어설프게 만들지 말 것 — 화질과 구도는 깔끔하게\n' +
    '- 중요: 쿠팡 상품 썸네일에는 "25개", "2세트", "국내최초" 같은 수량/판촉 배지나 스티커, 워터마크가 이미지 위에 합성되어 있는 경우가 많다. ' +
    '이런 배지·스티커·숫자 라벨·워터마크는 상품 실물이 아니라 판매 페이지가 나중에 덧붙인 그래픽이므로 절대 따라 그리지 말 것 — 상품 실물만 옮겨온다\n' +
    '- 로고나 텍스트를 새로 만들어내지 말 것 (제품 포장에 원래 인쇄된 것 외에 어떤 글자·숫자·배지도 추가 금지)\n' +
    '- 사람, 손, 신체 일부, 얼굴, 실루엣은 절대 등장시키지 말 것 — 사람이 어설프게 나오면 오히려 AI 티가 남. 상품과 배경만으로 구성';

...
- 길고 딱딱한 레시피 설명서처럼 쓰지 말고, 6~12줄 정도로 짧고 읽기 쉽게 쓴다.
- 첫 줄은 음식명/레시피명으로 시작해도 된다.
- 그 다음 줄부터 핵심 재료와 양을 짧게 이어 쓴다.
- 조리법은 2~5줄 안에 압축한다.
- 재료 구간, 조리 구간, 핵심 포인트 구간 사이에는 빈 줄을 하나 넣는다.
- 댓글 역시 한 덩어리로 붙여 쓰지 않는다.
...
comment도 재료/조리/핵심 포인트 사이에 빈 줄을 넣어서 한 덩어리로 붙여 쓰지 말 것.`;

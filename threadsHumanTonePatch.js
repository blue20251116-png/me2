...
function getExamples(isRecipe) {
  return isRecipe
    ...
    : `친구 집 갔다가 이거 처음 봤어\n뭐 하는 건가 한참 봤거든ㅋㅋ\n\n틈에 넣고 한번 슥 미는데\n안에서 먼지가 계속 나오는 거야\n\n집에 와서 우리 집 보니까 갑자기 신경 쓰였어\n\n밤산책하다가 앞에 강아지 발만 반짝이길래\n뭐지? 하고 계속 봤어ㅋㅋ\n\n가까이 보니까 신발에서 불이 들어오는 거였어\n멀리서도 바로 보여서 좀 신기했어`;
}
...
- 상황형 목격형 지인계기형 문제형 실패형 결과선공개형 우연발견형 의외성형 등 소재에 맞는 시작을 자유롭게 고른다
- '와 이거 미쳤다ㅋㅋ' '아니 이거 뭐야ㅋㅋ' '왜 이제 알았지ㅋㅋ' 같은 범용 후킹은 금지는 아니지만 정말 자연스러울 때만 드물게 쓴다
...
console.log('[Threads][HUMAN TONE] v10 상황/사건 우선 + 자연스러운 줄호흡 + 음슴체/더라체 차단');

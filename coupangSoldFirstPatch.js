...
function patchSource(src, filename) {
  ...
  console.log('[Autopilot][COUPANG SOLD-FIRST] v3 sold 정체성 토큰과 검색 문맥 분리 + 국가 단서 강제 + 후보 정체성 재검증 + 불일치 fail-closed');
  return src;
}
